...
//  v2.1: независимая инициализация (SplitMix64), выход без смешивания
// ═══════════════════════════════════════════════════════════════
...
private:
    ...
    // V2.1: сырой выход — SplitMix64 смешивание убрано (ломало MaxOft в BigCrush)
    // Независимая инициализация seed() уже разрывает линейную связь a-b,
    // делая полиномиальную атаку неприменимой (3 неизвестных вместо 1)
...
public:
    ...
    // V2.1: три независимых хеша через SplitMix64 — разрывает линейную связь a-b
